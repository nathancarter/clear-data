...
class TestSeriesBasics( unittest.TestCase ):
	...
	def test_is_a_function ( self ):
		...
		self.assertTrue( unique_inputs.is_a_function( unique_outputs ) )
		self.assertTrue( unique_inputs.is_a_function( repeat_outputs1 ) )
		self.assertTrue( unique_inputs.is_a_function( repeat_outputs2 ) )
		# with repeat inputs it may or may not be, depending on the outputs
		self.assertFalse( repeat_inputs.is_a_function( unique_outputs ) )
		self.assertFalse( repeat_inputs.is_a_function( repeat_outputs1 ) )
		self.assertTrue( repeat_inputs.is_a_function( repeat_outputs2 ) )
	...
	def test_to_function ( self ):
		...
		f1 = unique_inputs.to_function( unique_outputs )
		f2 = unique_inputs.to_function( repeat_outputs1 )
		f3 = unique_inputs.to_function( repeat_outputs2 )
		f4 = repeat_inputs.to_function( repeat_outputs2 )
	...
	def test_to_function ( self ):
		...
		d1 = unique_inputs.to_dictionary( unique_outputs )
		d2 = unique_inputs.to_dictionary( repeat_outputs1 )
		d3 = unique_inputs.to_dictionary( repeat_outputs2 )
		d4 = repeat_inputs.to_dictionary( repeat_outputs2 )
		...
		self.assertEqual( d1, unique_inputs.to_dict( unique_outputs ) )
		self.assertEqual( d2, unique_inputs.to_dict( repeat_outputs1 ) )
		self.assertEqual( d3, unique_inputs.to_dict( repeat_outputs2 ) )
		self.assertEqual( d4, repeat_inputs.to_dict( repeat_outputs2 ) )
